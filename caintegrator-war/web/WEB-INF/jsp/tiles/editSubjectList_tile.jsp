...
<div class="pagehelp"><a href="javascript:openWikiHelp('FoDnAg', 'id-5-ViewingQueryResults-EditingaGeneorSubjectList')" class="help">
&nbsp;</a>
</div>
                ...
                <td colspan="2" style="padding: 5px;">    
                    ...
                    <s:if test="editOn">
                        <s:form id="editListForm" name="editListForm" action="editSubjectList" method="post" 
                            ...
                            <s:textfield id="listName" name="listName" label="Subject List Name" size="100" theme="css_xhtml" /><br>
