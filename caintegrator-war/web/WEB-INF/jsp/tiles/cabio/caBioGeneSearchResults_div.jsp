    ...
    <s:if test="%{!caBioPathways.empty}">
        ...
        <s:property value="#numberPathways" /> pathway(s) found.
            ...
            <s:div cssClass="columnWrapper">
                ...
                <s:div cssClass="columnHeader" cssStyle="float: left; width: 225px;"> Title </s:div>
                <s:div cssClass="columnHeader" cssStyle="float: left; width: 400px; padding-left: 2px;"> Description </s:div>
            </s:div><br>
            <s:iterator value="caBioPathways" status="status">
                <s:if test="#status.odd == true">
                    <s:div cssClass="columnWrapper" cssStyle="background-color: #ffffff;">
                       ...
                       <s:div cssClass="left3" cssStyle="width: 225px;"><s:property value="displayValue" /></s:div>
                       <s:div cssClass="right" cssStyle="width: 400px;" title="%{description}"><s:property value="displayableDescription" /><s:div cssStyle="font-size: .9em;font-style: italic">  (mouseover for full description)</s:div></s:div>
                    </s:div><br>
                </s:if>
                <s:else>
