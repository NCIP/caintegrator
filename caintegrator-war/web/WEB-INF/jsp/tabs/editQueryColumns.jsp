...
<!--Columns-->
    ...
    <s:if test="queryForm.resultConfiguration.resultType == 'geneExpression'">
        ...
        <b>Select Results Orientation: </b> 
            <s:radio name="queryForm.resultConfiguration.orientation"
                list="@gov.nih.nci.caintegrator.domain.application.ResultsOrientationEnum@getValueToDisplayableMap()"
                listKey="key" 
                listValue="value" />
        </div>  
    ...
    <s:elseif test="queryForm.resultConfiguration.resultType == 'copyNumber'">
        ...
        <b>Select Results Orientation: </b> 
            <s:radio name="queryForm.resultConfiguration.orientation"
                list="@gov.nih.nci.caintegrator.domain.application.ResultsOrientationEnum@getCopyNumberValueToDisplayableMap()"
                listKey="key" 
                listValue="value" />
        </div>  
