...
import static gov.nih.nci.caintegrator.TestDataFiles.INVALID_FILE_DOESNT_EXIST;
import static gov.nih.nci.caintegrator.TestDataFiles.INVALID_FILE_EMPTY;
import static gov.nih.nci.caintegrator.TestDataFiles.INVALID_FILE_MISSING_VALUE;
import static gov.nih.nci.caintegrator.TestDataFiles.INVALID_FILE_NO_DATA;
import static gov.nih.nci.caintegrator.TestDataFiles.VALID_FILE;
import static gov.nih.nci.caintegrator.TestDataFiles.VALID_FILE_TIMEPOINT;
...
import gov.nih.nci.caintegrator.application.study.SubjectAnnotationHandler;
...
public class AnnotationFileTest {
    ...
    /**
     * Test method for {@link gov.nih.nci.caintegrator.application.study.DelimitedTextannotationFile#validateFile()}.
