...
import gov.nih.nci.caintegrator.application.arraydata.NetCDFManager;
...
public class NetCDFManagerTest extends AbstractMockitoTest {
    private NetCDFManager manager;
    private long nextArrayDataId = 0L;

    @Before
    public void setUp() {
        manager = new NetCDFManager(fileManager);
    }
    ...
    public void testStoreValues() throws IOException {
        ...
        File netCdfFile = new File(fileManager.getStudyDirectory(study),
