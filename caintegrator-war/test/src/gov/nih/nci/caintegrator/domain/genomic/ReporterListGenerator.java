...
public final class ReporterListGenerator extends AbstractTestDataGenerator<ReporterList> {
    ...
    public void setValues(ReporterList reporterList, Set<AbstractCaIntegrator2Object> nonCascadedObjects) {
        ...
        GeneExpressionReporter reporter =
                GeneExpressionReporterGenerator.INSTANCE.createPopulatedPersistentObject(nonCascadedObjects);
        reporter.setIndex(0);
        reporter.setReporterList(reporterList);
        reporterList.getReporters().add(reporter);
        DnaAnalysisReporter reporter2 =
                DnaAnalysisReporterGenerator.INSTANCE.createPopulatedPersistentObject(nonCascadedObjects);
