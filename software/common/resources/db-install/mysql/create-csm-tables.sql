...
;
CREATE INDEX IDX_CSM_GROUP_APPLICATION_ID ON CSM_GROUP(APPLICATION_ID)
;
...
;
CREATE INDEX IDX_CSM_PROTECTION_GROUP_APPLICATION_ID ON CSM_PROTECTION_GROUP(APPLICATION_ID)
;
...
;
CREATE INDEX IDX_CSM_PROTECTION_GROUP_PARENT_PROTECTION_GROUP_ID ON CSM_PROTECTION_GROUP(PARENT_PROTECTION_GROUP_ID)
;
CREATE INDEX IDX_CSM_PG_PE_PROTECTION_ELEMENT_ID ON CSM_PG_PE(PROTECTION_ELEMENT_ID)
;
CREATE INDEX IDX_CSM_PG_PE_PROTECTION_GROUP_ID ON CSM_PG_PE(PROTECTION_GROUP_ID)
;
...
;
CREATE INDEX IDX_CSM_ROLE_APPLICATION_ID ON CSM_ROLE(APPLICATION_ID)
;
ALTER TABLE CSM_ROLE
ADD CONSTRAINT UQ_ROLE_ROLE_NAME UNIQUE (APPLICATION_ID, ROLE_NAME)
;
CREATE INDEX IDX_CSM_ROLE_PRIVILEGE_PRIVILEGE_ID ON CSM_ROLE_PRIVILEGE(PRIVILEGE_ID)
;
ALTER TABLE CSM_ROLE_PRIVILEGE
ADD CONSTRAINT UQ_ROLE_PRIVILEGE_ROLE_ID UNIQUE (PRIVILEGE_ID, ROLE_ID)
;
CREATE INDEX IDX_CSM_ROLE_PRIVILEGE_ROLE_ID ON CSM_ROLE_PRIVILEGE(ROLE_ID)
;
ALTER TABLE CSM_USER
ADD CONSTRAINT UQ_LOGIN_NAME UNIQUE (LOGIN_NAME)
;
CREATE INDEX IDX_CSM_USER_GROUP_USER_ID ON CSM_USER_GROUP(USER_ID)
;
CREATE INDEX IDX_CSM_USER_GROUP_GROUP_ID ON CSM_USER_GROUP(GROUP_ID)
;
CREATE INDEX IDX_CSM_USER_GROUP_ROLE_PG_GROUP_ID ON CSM_USER_GROUP_ROLE_PG(GROUP_ID)
;
CREATE INDEX IDX_CSM_USER_GROUP_ROLE_PG_ROLE_ID ON CSM_USER_GROUP_ROLE_PG(ROLE_ID)
;
CREATE INDEX IDX_CSM_USER_GROUP_ROLE_PG_PROTECTION_GROUP_ID ON CSM_USER_GROUP_ROLE_PG(PROTECTION_GROUP_ID)
;
CREATE INDEX IDX_CSM_USER_GROUP_ROLE_PG_USER_ID ON CSM_USER_GROUP_ROLE_PG(USER_ID)
;
CREATE INDEX IDX_CSM_USER_PE_USER_ID ON CSM_USER_PE(USER_ID)
;
CREATE INDEX IDX_CSM_USER_PE_PROTECTION_ELEMENT_ID ON CSM_USER_PE(PROTECTION_ELEMENT_ID)
;
