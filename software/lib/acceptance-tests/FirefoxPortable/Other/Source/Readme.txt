...
enter LocalHomepage=homepage/homepage.html.  This is mainly of use with the RunLocally option.
...
Please note that this option will PREVENT THE PORTABLE CLEANUP PROCESS FROM RUNNING
and will leave files behind if run on a PC without Firefox installed.  It is meant to 
be run on your own PC so you can run multiple copies of Firefox.
