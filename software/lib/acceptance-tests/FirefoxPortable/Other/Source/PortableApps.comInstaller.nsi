...
!define FILENAME "Firefox_Portable_2.0.0.14_en-us"
...
Section "!App Portable (required)"
	...
	WriteINIStr "$INSTDIR\Data\settings\FirefoxPortableSettings.ini" "FirefoxPortableSettings" "AgreedToLicense" "YES"
