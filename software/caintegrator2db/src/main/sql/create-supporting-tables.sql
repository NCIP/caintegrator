...
alter table ANNOTATION_FIELD_DESCRIPTOR_KEYWORDS 
    add index FK_ANNOTATION_FIELD_DESC_KEYWORDS_ANNOTATION_FIELD_DESC (descriptor_id), 
    add constraint FK_ANNOTATION_FIELD_DESC_KEYWORDS_ANNOTATION_FIELD_DESC foreign key (descriptor_id) references ANNOTATION_FIELD_DESCRIPTOR (ID);
