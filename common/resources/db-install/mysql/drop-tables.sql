...
ALTER TABLE ARRAY_DATA DROP FOREIGN KEY FK_ARRAY_DATA_ARRAY_DATA_MATRIX;
ALTER TABLE GENE_EXPRESSION_REPORTER DROP FOREIGN KEY FK_GENE_EXPRESSION_REPORTER_GENE;
