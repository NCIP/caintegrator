...
(
    ...
    VALUE_MEANING_ID varchar(255),
    VALUE_MEANING_VERSION varchar(50),
...
(
    ...
    PRIMARY KEY (PERMISSIBLE_VALUE_ID, SELECTED_VALUE_CRITERION_ID)
) TYPE=InnoDB;
...
(
    ...
    INPUT_ZIP_FILE_PATH VARCHAR(255),
    RESULTS_ZIP_FILE_PATH VARCHAR(255),
    PRIMARY KEY (ID),
    KEY (STUDY_SUBSCRIPTION_ID)
) TYPE=InnoDB;
...
(
	...
	CDE_REGISTRATION_STATUS VARCHAR(100),
	CDE_WORKFLOW_STATUS VARCHAR(100),
	CDE_PUBLIC_ID BIGINT,
	CDE_VERSION VARCHAR(20),
	VD_PUBLIC_ID BIGINT,
	VD_LONG_NAME VARCHAR(255),
	HIGH_VALUE_NUMBER BIGINT,
	LOW_VALUE_NUMBER BIGINT,
...
ALTER TABLE PERMISSIBLE_VALUE ADD CONSTRAINT FK_PERMISSIBLE_VALUE_VALUE_DOMAIN 
    FOREIGN KEY (VALUE_DOMAIN_ID) references ANNOTATION_DEFINITION (ID);
...
ALTER TABLE SELECTED_VALUE_CRITERIA_PERMISSIBLE_VALUES ADD CONSTRAINT FK_SELECTED_VALUE_CRITERIA_PERMISSIBLE_VALUES_PERMISSIBLE 
    FOREIGN KEY (PERMISSIBLE_VALUE_ID) references PERMISSIBLE_VALUE (ID);
