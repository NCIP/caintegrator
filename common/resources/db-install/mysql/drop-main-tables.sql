...
ALTER TABLE SURVIVAL_VALUE_DEFINITION DROP CONSTRAINT FK_SURVIVAL_VALUE_DEFINITION_SURVIVAL_START_DATE;
ALTER TABLE SURVIVAL_VALUE_DEFINITION DROP CONSTRAINT FK_SURVIVAL_VALUE_DEFINITION_DEATH_DATE;
ALTER TABLE SURVIVAL_VALUE_DEFINITION DROP CONSTRAINT FK_SURVIVAL_VALUE_DEFINITION_LAST_FOLLOWUP_DATE;
ALTER TABLE SURVIVAL_VALUE_DEFINITION DROP CONSTRAINT FK_SURVIVAL_VALUE_DEFINITION_STUDY;
ALTER TABLE ABSTRACT_PERMISSIBLE_VALUE DROP CONSTRAINT FK_ABSTRACT_PERMISSIBLE_VALUE_VALUE_DOMAIN;
ALTER TABLE COMMON_DATA_ELEMENT DROP CONSTRAINT FK_COMMON_DATA_ELEMENT_VALUE_DOMAIN;
