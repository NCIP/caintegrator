...
ALTER TABLE NUMERIC_ANNOTATION_VALUE DROP CONSTRAINT FK_NUMERIC_ANNOTATION_VALUE_ABSTRACT_ANNOTATION_VALUE;
ALTER TABLE STRING_ANNOTATION_VALUE DROP CONSTRAINT FK_STRING_ANNOTATION_VALUE_ABSTRACT_ANNOTATION_VALUE ;
ALTER TABLE DATE_ANNOTATION_VALUE DROP CONSTRAINT FK_DATE_ANNOTATION_VALUE_ABSTRACT_ANNOTATION_VALUE ;
ALTER TABLE ABSTRACT_PERMISSABLE_VALUE DROP CONSTRAINT FK_ABSTRACT_PERMISSABLE_VALUE_ANNOTATION_DEFINITION ;
ALTER TABLE NUMERIC_PERMISSABLE_VALUE DROP CONSTRAINT FK_NUMERIC_PERMISSABLE_VALUE_ABSTRACT_PERMISSABLE_VALUE; 
ALTER TABLE STRING_PERMISSABLE_VALUE DROP CONSTRAINT FK_STRING_PERMISSABLE_VALUE_ABSTRACT_PERMISSABLE_VALUE ;
ALTER TABLE DATE_PERMISSABLE_VALUE DROP CONSTRAINT FK_DATE_PERMISSABLE_VALUE_ABSTRACT_PERMISSABLE_VALUE ;
...
ALTER TABLE COMPOUND_CRITERION DROP CONSTRAINT FK_COMPOUND_CRITERION_ABSTRACT_CRITERION;     
ALTER TABLE ABSTRACT_ANNOTATION_CRITERION DROP CONSTRAINT FK_ABSTRACT_ANNOTATION_CRITERION_ANNOTATION_DEFINITION; 
ALTER TABLE ABSTRACT_ANNOTATION_CRITERION DROP CONSTRAINT FK_ABSTRACT_ANNOTATION_CRITERION_ABSTRACT_CRITERION; 
ALTER TABLE STRING_COMPARISON_CRITERION DROP CONSTRAINT FK_STRING_COMPARISON_CRITERION_ABSTRACT_ANNOTATION_CRITERION; 
ALTER TABLE NUMERIC_COMPARISON_CRITERION DROP CONSTRAINT FK_NUMERIC_COMPARISON_CRITERION_ABSTRACT_ANNOTATION_CRITERION; 
ALTER TABLE SELECTED_VALUE_CRITERION DROP CONSTRAINT FK_SELECTED_VALUE_CRITERION_ABSTRACT_ANNOTATION_CRITERION; 
